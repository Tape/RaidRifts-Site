 ...
 * Functions
 */
if(!Array.prototype.indexOf){Array.prototype.indexOf=function(a,b){if(typeof(b)!='number')b=0;for(index=b,len=this.length;index<len;index++)if(this[index]==a)return index;return-1}}if(!Array.prototype.deleteElement){Array.prototype.deleteElement=function(a){this.splice(this.indexOf(a),1)}}(function($){$.fn.rrSlideIn=function(){var e=$(this);e.slideDown(500).trigger('blur');return e};$.fn.rrSlideOut=function(a){var e=$(this),b=a||3000;e.delay(b-500).slideUp(500);setTimeout(function(){e.remove()},b+500);return e}})(jQuery);
